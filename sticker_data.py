STICKERS = {
    ...
    "IRN (Irã)": {"code": "ir", "count": 20},
    "NZL (Nova Zelândia)": {"code": "nz", "count": 20},
    "ESP (Espanha)": {"code": "es", "count": 20},
    "CPV (Cabo Verde)": {"code": "cv", "count": 20},
    "KSA (Arábia Saudita)": {"code": "sa", "count": 20},
    ...
    "COD (Congo DR)": {"code": "cd", "count": 20},
    "UZB (Uzbequistão)": {"code": "uz", "count": 20},
    "COL (Colômbia)": {"code": "co", "count": 20},
    "ENG (Inglaterra)": {"code": "gb-eng", "count": 20},
    "CRO (Croácia)": {"code": "hr", "count": 20},
    "GHA (Gana)": {"code": "gh", "count": 20},
